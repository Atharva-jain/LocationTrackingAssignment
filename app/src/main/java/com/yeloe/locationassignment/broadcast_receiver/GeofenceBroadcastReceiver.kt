...
class GeofenceBroadcastReceiver() : BroadcastReceiver() {
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (geofenceTransition) {
            Geofence.GEOFENCE_TRANSITION_ENTER -> {
                ...
                saveEntryToDatabase(context, System.currentTimeMillis())
            }
    ...
    private fun saveEntryToDatabase(context: Context, entryTime: Long) {
...
//        val lastVisit = mVisitViewModel.getLastVisit()
//        lastVisit?.let {
//            val duration = (exitTime - SimpleDateFormat(
//                "HH:mm:ss",
//                Locale.getDefault()
//            ).parse(it.entryTime)!!.time) / 1000
//            mVisitViewModel.updateVisit(
//                lastVisit.copy(
//                    exitTime = SimpleDateFormat(
//                        "HH:mm:ss",
//                        Locale.getDefault()
